                    ...
                    <div className="d-flex align-items-end justify-content-between">
                        ...
                        {/* <div>
                            <div className="d-flex">
                                ...
                                <Link to="/instructor/profile/" className="btn btn-success btn-sm d-none d-md-block ms-2">
                                    {" "}
                                    Setting <i className="fas fa-gear"></i>
                                </Link>
                                <Link to="/base/contact/" className="btn btn-danger btn-sm d-none d-md-block ms-2">
                                    {" "}
