...
function CourseDetail() {
    ...
    useEffect(() => {
        apiInstance.get(`course/course-detail/${param.slug}/`).then((res) => {
            setCourse(res.data);
        });
    }, []);
    console.log(course);
    ...
    const addToCart = async (courseId, userId, price, country, cartId) => {
        ...
        setIsAddingToCart("Adding To Cart");
                            ...
                            <div className="col-lg-8">
                                ...
                                <ul className="list-inline mb-0">
                                    <li className="list-inline-item h6 me-3 mb-1 mb-sm-0">
                                        ...
                                        <span className="ms-2">{course.average_rating || "0/5"}</span>
                                    </li>
                                    <li className="list-inline-item h6 me-3 mb-1 mb-sm-0">
                                    ...
                                    <li className="list-inline-item h6 me-3 mb-1 mb-sm-0">
                                        ...
                                        {moment(course.date).format("MM/DD/YYYY")}
                                    </li>
                                    ...
                                    <div className="card-body p-4">
                                        <div className="tab-content pt-2" id="course-pills-tabContent">
                                                ...
                                                <div className="" id="accordionExample2">
                                                    ...
                                                    {course?.curriculum?.map((c, index) => (
                                                        <div className="accordion-item mb-3 p-3 bg-light rounded-3" key={index}>
                                                            ...
                                                            <div id={`collapse-${c.variant_id}`} className="accordion-collapse collapse show" aria-labelledby={`heading-${c.variant_id}`} data-bs-parent="#accordionExample2">
                                                                                ...
                                                                                <>
                                                                                    <div className="position-relative d-flex align-items-center">
                                                                                        {l.preview === true ? (
                                                                                            ...
                                                                                            <button disabled className="btn btn-danger-soft btn-round btn-sm mb-0 stretched-link position-static">
                                                    ...
                                                    <div className="row g-0 align-items-center">
                                                        <div className="col-md-5">
                                                            ...
                                                            <img
                                                                ...
                                                                alt={`${course?.teacher?.full_name} Image`}
                                                                style={{
                                                                    width: "100%",
                                                                    height: "100%",
                                                                    objectFit: "cover",
                                            ...
                                            <div className="tab-pane fade" id="course-pills-4" role="tabpanel" aria-labelledby="course-pills-tab-4">
                                                {/* Review START */}
                                                <div className="row">
                                                    <h5 className="mb-2">Our Student Reviews</h5>
                                                </div>
                                                {/* Review END */}
                                                ...
                                                <div className="row">
                                                    {course.reviews?.map((r, index) => (
                                                        <>
                                                            <div className="d-md-flex my-2 shadow p-3 rounded-3" key={index}>
                                                                <div className="avatar avatar-xl me-4 flex-shrink-0">
                                                                    <img
                                                                        className="avatar-img rounded-circle"
                                                                        src={r?.profile?.image || "https://thumbs.dreamstime.com/b/default-avatar-profile-icon-vector-social-media-user-photo-183042379.jpg"}
                                                                        style={{
                                                                            width: "50px",
                                                                            height: "50px",
                                                                            borderRadius: "50%",
                                                                ...
                                                                <div>
                                                                    <div className="d-sm-flex mt-1 mt-md-0 align-items-center">
                                                                        <h5 className="me-3 mb-0">{r?.profile?.full_name}</h5>
                                                                        {/* Review star */}
                                                                        <ul className="list-inline mb-0">
                                                                            <Rater
                                                                                total={5}
                                                                    ...
                                                                    {/* Info */}
                                                                    <p className="small mb-2">{moment(r.date).format("MMM DD, YYYY")}</p>
                                                                    <p className="mb-2">
                                                                        <b>Review:</b> {r.review}
                                                                    </p>
                                                                    {r.reply !== null && (
                                                                        <p className="mb-2">
                                                                            <b>Response:</b> {r.reply}
                                                                        </p>
                                                                    )}
                                                                </div>
                                                            </div>
                                                ...
                                                <div className="accordion accordion-flush" id="accordionExample">
                                                    ...
                                                    <div className="accordion-item">
                                                        ...
                                                        <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                                            <div className="accordion-body pt-0">
                                                                Comfort reached gay perhaps chamber his six detract besides add. Moonlight newspaper up its enjoyment agreeable depending. Timed voice share led him to widen noisy young. At weddings believed laughing although the material does the
                                                                exercise of. Up attempt offered ye civilly so sitting to. She new course gets living within Elinor joy. She rapturous suffering concealed.
                                                            </div>
                                                        </div>
                                                    </div>
                                                    {/* Item */}
                                                    <div className="accordion-item">
                                                        ...
                                                        <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                                            <div className="accordion-body pt-0">
                                                                ...
                                                                <p className="mt-2">
                                                                    Person she control of to beginnings view looked eyes Than continues its and because and given and shown creating curiously to more in are man were smaller by we instead the these sighed Avoid in the sufficient me real man longer of
                                                                    his how her for countries to brains warned notch important Finds be to the of on the increased explain noise of power deep asking contribution this live of suppliers goals bit separated poured sort several the was organization the
                                                                    if relations go work after mechanic But we've area wasn't everything needs of and doctor where would.
                                                                </p>
                                                                Go he prisoners And mountains in just switching city steps Might rung line what Mr Bulk; Was or between towards the have phase were its world my samples are the was royal he luxury the about trying And on he to my enough is was the
                                                                remember a although lead in were through serving their assistant fame day have for its after would cheek dull have what in go feedback assignment Her of a any help if the a of semantics is rational overhauls following in from our
                                                                hazardous and used more he themselves the parents up just regulatory.
                                                            </div>
                                                        </div>
                                                    </div>
                                                    {/* Item */}
                                                    <div className="accordion-item">
                                                        ...
                                                        <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                                            <div className="accordion-body pt-0">
                                                                Post no so what deal evil rent by real in. But her ready least set lived spite solid. September how men saw tolerably two behavior arranging. She offices for highest and replied one venture pasture. Applauded no discovery in newspaper
                                                                allowance am northward. Frequently partiality possession resolution at or appearance unaffected me. Engaged its was the evident pleased husband. Ye goodness felicity do disposal dwelling no. First am plate jokes to began to cause a
                                                                scale.
                                                    ...
                                                    <div className="accordion-item">
                                                        ...
                                                        <div id="collapseFour" className="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                                            <div className="accordion-body pt-0">
                                                                Night signs creeping yielding green Seasons together man green fruitful make fish behold earth unto you'll lights living moving sea open for fish day multiply tree good female god had fruitful of creature fill shall don't day fourth
                                                                lesser he the isn't let multiply may Creeping earth under was You're without which image stars in Own creeping night of wherein Heaven years their he over doesn't whose won't kind seasons light Won't that fish him whose won't also it
                                                                dominion heaven fruitful Whales created And likeness doesn't that Years without divided saying morning creeping hath you'll seas cattle in multiply under together in us said above dry tree herb saw living darkness without have won't for
                                                                i behold meat brought winged Moving living second beast Over fish place beast image very him evening Thing they're fruit together forth day Seed lights Land creature together Multiply waters form brought.
                                                            </div>
                                                        </div>
                                                    </div>
                                                    {/* Item */}
                                                    <div className="accordion-item">
                                                        ...
                                                        <div id="collapseFive" className="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                                                            <div className="accordion-body pt-0">
                                                                Smile spoke total few great had never their too Amongst moments do in arrived at my replied Fat weddings servants but man believed prospect Companions understood is as especially pianoforte connection introduced Nay newspaper can
                                                                sportsman are admitting gentleman belonging his Is oppose no he summer lovers twenty in Not his difficulty boisterous surrounded bed Seems folly if in given scale Sex contented dependent conveying advantage.
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div className="modal-dialog">
                                                            <div className="modal-content">
                                                                ...
                                                                <div className="modal-body">
                                                                    <ReactPlayer url={`${course?.file}`} controls width={"100%"} height={"100%"} />
                                                                </div>
                                            ...
                                            <div className="card-body px-3">
                                                ...
                                                <div className="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div>
                                                        <div className="d-flex align-items-center">
                                                            <h3 className="fw-bold mb-0 me-2">${course?.price || "0.00"}</h3>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="mt-3 d-sm-flex justify-content-sm-between ">
                                                    {isAddingToCart === "Add To Cart" && (
                                                        <button onClick={() => addToCart(course.id, userId, course.price, country, cartId)} className="btn btn-primary mb-0 w-100 me-2">
                                                            Add To Cart <i className="fas fa-shopping-cart"></i>
                                                        </button>
                                                    )}
                                                    {isAddingToCart === "Adding To Cart" && (
                                                        <button onClick={() => addToCart(course.id, userId, course.price, country, cartId)} className="btn btn-primary mb-0 w-100 me-2">
                                                            Adding To Cart <i className="fas fa-spinner fa-spin"></i>
                                                        </button>
                                                    )}
                            ...
                            <div className="col-md-12">
                                <div className="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                                    <div className="col">
                                        ...
                                        <div className="card card-hover">
                                            <Link to={`/course-detail/slug/`}>
                                                <img src="https://geeksui.codescandy.com/geeks/assets/images/course/course-css.jpg" alt="course" className="card-img-top" />
                                            </Link>
                                            {/* Card Body */}
                                            <div className="card-body">
                                    ...
                                    <div className="col">
                                        ...
                                        <div className="card card-hover">
                                            <Link to={`/course-detail/slug/`}>
                                                <img src="https://geeksui.codescandy.com/geeks/assets/images/course/course-angular.jpg" alt="course" className="card-img-top" />
                                            </Link>
                                            {/* Card Body */}
                                            <div className="card-body">
                                                <div className="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <div className="col">
                                        ...
                                        <div className="card card-hover">
                                            <Link to={`/course-detail/slug/`}>
                                                <img src="https://geeksui.codescandy.com/geeks/assets/images/course/course-react.jpg" alt="course" className="card-img-top" />
                                            </Link>
                                            {/* Card Body */}
                                            <div className="card-body">
                                                <div className="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <div className="col">
                                        ...
                                        <div className="card card-hover">
                                            <Link to={`/course-detail/slug/`}>
                                                <img src="https://geeksui.codescandy.com/geeks/assets/images/course/course-python.jpg" alt="course" className="card-img-top" />
                                            </Link>
                                            {/* Card Body */}
                                            <div className="card-body">
                                                <div className="d-flex justify-content-between align-items-center mb-3">
